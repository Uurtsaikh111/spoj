...
//   console.log(topPerformersReport(employees, 4.8));
  ...
  // function highPaidEmployeesByDepartment(main, b, num, c) {
  //   let hightPayEmployees = main.filter((a) => {
  //     return a.department == b && a.salary >= num && a.performanceRating > c;
  //   });
  //   return hightPayEmployees;
  // }
  // console.log(highPaidEmployeesByDepartment(employees, "Finance", 90000, 4.7));
